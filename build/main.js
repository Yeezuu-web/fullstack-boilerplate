...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var RedisStore, PORT_1, app, config, document, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    RedisStore = Store(session);
                    PORT_1 = process.env.PORT || 8000;
                ...
                case 1:
                    ...
                    return [4 /*yield*/, app.listen(PORT_1, function () { return console.log("Server started on port - localhost:".concat(PORT_1)); })];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
